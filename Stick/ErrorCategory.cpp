...
namespace stick
{
ErrorCategory::ErrorCategory(const String & _name) : m_name(_name)
{
}
...
NoErrorCategory::NoErrorCategory() : ErrorCategory("No Error")
{
}
...
MiscErrorCategory::MiscErrorCategory() : ErrorCategory("Misc")
{
}
...
SystemErrorCategory::SystemErrorCategory() : ErrorCategory("System")
{
}
