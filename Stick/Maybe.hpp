...
class Maybe
{
  public:
    ...
    inline Maybe() : m_bHasValue(false)
    {
    }

    inline Maybe(const T & _value) : m_bHasValue(true)
    {
        new (m_data) T(_value);
    }

    inline Maybe(T && _value) : m_bHasValue(true)
    {
    ...
    inline Maybe(U && _value) : m_bHasValue(true)
    {
        new (m_data) T(std::move(_value));
    }

    inline Maybe(const Maybe & _other) : m_bHasValue(_other.m_bHasValue)
    {
        if (m_bHasValue)
            new (m_data) T(_other.value());
    }

    inline Maybe(Maybe && _other) : m_bHasValue(_other.m_bHasValue)
    {
        if (m_bHasValue)
...
class Maybe<T &>
{
  public:
    ...
    inline Maybe() : m_ptr(nullptr)
    {
    }

    inline Maybe(T & _value) : m_ptr(&_value)
    {
    }

    inline Maybe(const Maybe & _other) : m_ptr(_other.m_ptr)
    {
    }
