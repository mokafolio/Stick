 ...
 */
String fromSegments(const StringArray & _segments,
                    bool _bAddLeadingSeparator = false,
                    bool _bAddTrailingSeparator = false);

String fromSegments(const StringArray & _segments,
                    bool _bAddLeadingSeparator,
                    bool _bAddTrailingSeparator,
                    Allocator & _alloc);

/**
 * @brief Normalize a pathname by collapsing redundant separators and up-level references so that
