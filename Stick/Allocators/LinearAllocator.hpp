...
class STICK_API LinearAllocator
{
  public:
    ...
    inline Block allocate(Size _byteCount, Size _alignment)
    {
        ...
        void * alignedAddr =
            reinterpret_cast<void *>(reinterpret_cast<UPtr>(m_position) + adjustment);
    ...
    inline bool owns(const Block & _blk)
    {
        ...
        return _blk.ptr >= m_memory.ptr && reinterpret_cast<UPtr>(_blk.ptr) <=
                                               reinterpret_cast<UPtr>(m_memory.ptr) + m_memory.size;
    }
