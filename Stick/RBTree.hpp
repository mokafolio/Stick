    ...
    inline void deleteFix(Node * _node)
    {
        ...
        if (sibling->color == Color::Red)
        {
            ...
            sibling->parent->color =
                sibling->parent->color == Color::Red ? Color::Black : Color::Red;
        ...
        {
            STICK_ASSERT((!sibling->left || sibling->left->color == Color::Red) &&
                         (!sibling->right || sibling->right->color == Color::Red));
            sibling->color = sibling->parent->color;
            sibling->parent->color =
                sibling->parent->color == Color::Red ? Color::Black : Color::Red;
        }
        else if ((!bLeft && (sibling->right || sibling->right->color == Color::Black) &&
                  sibling->left->color == Color::Red) ||
                 (bLeft && (sibling->left || sibling->left->color == Color::Black) &&
